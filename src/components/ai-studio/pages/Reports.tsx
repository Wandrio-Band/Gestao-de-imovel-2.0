...
export const Reports: React.FC<ReportsProps> = ({ onNavigate }) => {
    ...
    const displayAssets = activeTab === 'financial'
        ? assets.filter(a => a.financingDetails)
        : assets;
        ...
        <div className="p-8 max-w-[1600px] mx-auto pb-24 animate-fade-in-up">
            ...
            <div className="flex items-center gap-2 mb-8 bg-white p-1.5 rounded-2xl w-fit border border-gray-100 shadow-sm">
                <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center gap-2 ${activeTab === 'dossier'
                ...
                <button
                    ...
                    className={`px-6 py-2.5 rounded-xl text-sm font-bold transition-all flex items-center gap-2 ${activeTab === 'financial'
                            ? 'bg-blue-50 text-blue-700 shadow-sm ring-1 ring-blue-100'
                            : 'text-gray-500 hover:bg-gray-50'
                        }`}
                >
                            ...
                            {displayAssets.map(asset => (
                                ...
                                >
                                    ...
                                    <div className="relative z-10 flex justify-between items-start mb-auto">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-white shadow-md backdrop-blur-md ${activeTab === 'dossier'
