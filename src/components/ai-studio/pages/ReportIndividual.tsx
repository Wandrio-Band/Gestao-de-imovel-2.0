            ...
            <div className="flex flex-col md:flex-row gap-8 mb-10">
                <div className="flex-1">
                    <div className="flex items-center gap-3 mb-4">
                        <span className={`px-3 py-1 rounded text-[10px] font-black uppercase tracking-wider border ${asset.type === 'Residencial' ? 'bg-blue-50 text-blue-700 border-blue-100' :
                                asset.type === 'Comercial' ? 'bg-purple-50 text-purple-700 border-purple-100' : 'bg-gray-50 text-gray-700 border-gray-200'
                            }`}>
                            {asset.type}
                        </span>
                        <span className={`px-3 py-1 rounded text-[10px] font-black uppercase tracking-wider border ${asset.status === 'Locado' ? 'bg-green-50 text-green-700 border-green-100' :
